...
**Last updated:** 2026-06-09 (CRITICAL FIX: photo-recognition outage resolved — the worker's GEMINI_API_KEY was dead, every photo was failing; re-set a fresh key. Also today: all 10 languages recorded (v113), iOS/UX/dashboard/landing fixes, new social card, and an automated recognition eval = 0 genuine misses across 109 items. FOLLOW-UPs: spot-check zh/ja/ko/hi/ar audio pronunciation; optional regen of the "square" test image for a literal 109/109.)
